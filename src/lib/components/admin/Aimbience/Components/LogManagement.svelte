<script lang="ts">
	...
	import LogFolderView from './LogFolderView.svelte';
	...
	// View mode state
	let viewMode: 'table' | 'folder' = 'folder';
			...
			<div class="flex gap-2">
				<div class="flex items-center gap-1 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
					<button
						...
						class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 {viewMode ===
						'table'
