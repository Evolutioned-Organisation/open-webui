...
export function validateFilename(filename: string): boolean {
	...
	// Check for valid filename characters (alphanumeric, dots, hyphens, underscores)
 ...
 */
export function validateNumericParameter(value: any, min: number = 0, max: number = Number.MAX_SAFE_INTEGER): number | null {
